...
- 从 GitHub 模板创建自己的 Mod 仓库，并使用模板提供的项目生成、构建和打包能力的开发者。
- 维护本模板仓库的文档、模板、MSBuild 骨架、CLI 和 GitHub Actions 的开发者。
...
- `docs/`：模板维护文档、跨具体 Mod 复用的太吾机制、平台机制、发布经验和跨项目判断；入口见 `docs/README.md`。
...
- `docs/development/README.md`：维护模板仓库、文档、模板、工具和工作流时使用的开发维护入口。
- `CONTRIBUTING.md`：提交 issue、讨论或 PR 前的贡献入口。
...
- `docs/README.md`：跨具体 Mod 复用的太吾机制、平台机制、发布经验和跨项目判断。

具体 Mod 的玩家说明、配置和运行边界见对应 `mods/<ModName>/README.md`。源码模块、组包内容和内部设计见
